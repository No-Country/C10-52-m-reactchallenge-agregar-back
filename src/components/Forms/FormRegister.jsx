...
const FormRegister = () => {
  ...
  const validationForm = Yup.object({
    ...
    password: Yup.string()
      .min(6, <p className=" text-sky-800 font-bold text-sm">La contraseña debe tener al menos 6 caracteres</p>)
      .required(<p className=" text-sky-800 font-bold text-sm">Debes ingresar una contraseña</p>),
